...
class Prm391GenZApplicationTests {
    ...
    void unicodeDataIsRepaired() {
        ...
        )).isEqualTo("GenZ Cinema Hà Đông");
        assertThat(jdbcTemplate.queryForObject(
                "SELECT COUNT(*) FROM Hotel", Integer.class
        )).isGreaterThanOrEqualTo(9);
        assertThat(jdbcTemplate.queryForObject(
                "SELECT phone FROM Hotel WHERE HotelId = 'HOTEL009'", String.class
        )).isEqualTo("0823 660 705");
        assertThat(jdbcTemplate.queryForObject(
    ...
    void businessTextColumnsUseUnicodeTypes() {
        ...
        assertUnicodeColumn("Hotel", "phone");
